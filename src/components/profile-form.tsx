...
export function ProfileForm(){
 ...
 useEffect(()=>{if(!universityId){setEducations([]);return;}apiRequestAllPages<Education>(`/universities/${universityId}/departments`).then(items=>setEducations(items.toSorted((a,b)=>turkish.compare(a.departmentName,b.departmentName)))).catch(()=>setMessage("Programlar yüklenemedi."));},[universityId]);
