...
export function InfiniteResults({kind,initial,totalElements,path,pageSize=24,showProgramUniversity=true}:{kind:Kind;initial:Result[];totalElements:number;path:string;pageSize?:number;showProgramUniversity?:boolean}){
