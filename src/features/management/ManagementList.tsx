...
export function ManagementList({users}:{users:boolean}){
 ...
 return <><p>{users?'Pasifleştirme tüm oturumları kapatır, Admin yetkisini kaldırır ve bekleyen başvuruları reddeder. İçerikler korunur.':'Soru ve yorumları gerekçeyle gizle veya geri yükle. İçerik metinleri yazarlarına aittir.'}</p>
