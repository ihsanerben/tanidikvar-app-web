...
export function ManagementList({users}:{users:boolean}){
 ...
 {!users&&<label>İçerik türü<select name="kind" defaultValue={params.get('kind')??'QUESTION'}><option value="QUESTION">Sorular</option><option value="COMMUNITY">Topluluk yorumları</option><option value="ADMIN">Admin cevapları</option></select></label>}
