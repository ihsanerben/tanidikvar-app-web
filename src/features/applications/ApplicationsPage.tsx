...
function ApplicationsList({manager,canApply}:{manager:boolean;canApply:boolean}){
 ...
 return <section className="profile-page"><div className="profile-heading"><div>{manager&&<span className="eyebrow">MANAGER PANEL</span>}<h1>{manager?'Admin başvuruları':'Başvurularım'}</h1></div></div>
