...
function ProfileLoader({id}:{id:string}){
 ...
 {p.biography&&<p className="answer-body">{p.biography}</p>}<h2>Cevapladığı sorular</h2><p>{p.answerCount} görünür Admin cevabı</p><AdminAnswerFeed path={'/api/admins/'+id+'/answers'} showQuestion/></section>
}
