...
export interface AdminAnswer {id:string;questionId:string;questionTitle:string;authorId:string|null;authorName:string;activeAdmin:boolean;universityName:string|null;departmentName:string|null;educationStatus:string|null;graduationYear:number|null;avatarFileId:string|null;occupation:string|null;company:string|null;body:string;publishedAt:string;editedAt:string|null;deletedAt:string|null;moderatedAt:string|null;likeCount?:number;version:number}
...
export interface AdminProfile {linkedinUrl?:string|null;portfolioUrl?:string|null;id:string;name:string;activeAdmin:boolean;universityName:string;departmentName:string;educationStatus:string;graduationYear:number|null;biography:string|null;occupation:string|null;company:string|null;avatarFileId:string|null;answerCount:number;communityAnswerCount:number;createdAt:string}
...
export function adminAnswer(v:unknown):AdminAnswer {
 if(isRecord(v)&&v.likeCount!==undefined&&!Number.isSafeInteger(v.likeCount))throw invalid()
