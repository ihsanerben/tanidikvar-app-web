...
export const metadata: Metadata = {
  ...
  title: { default: "TanıdıkVar — Tercih Yolunda Bir Tanıdığın Olsun", template: "%s | TanıdıkVar" },
  ...
  openGraph: {
    ...
    title: "TanıdıkVar — Tercih Yolunda Bir Tanıdığın Olsun",
      ...
      <body>
       <NotificationProvider>
        ...
        <header className="site-header legacy-header">
          <Link className="brand" href="/" aria-label="TanıdıkVar ana sayfa"><Image className="brand-logo-full" src="/logo.svg" alt="" width={158} height={38} priority /><Image className="brand-logo-mark" src="/logo-mark.svg" alt="" width={38} height={38} priority /></Link>
          <HeaderPrimaryNav />
        ...
        <footer className="site-footer legacy-footer"><Link className="brand footer-brand" href="/" aria-label="TanıdıkVar ana sayfa"><Image src="/logo-wordmark.svg" alt="" width={110} height={28} /></Link><span>Gerçek deneyim, doğru tercih.</span><nav aria-label="Alt menü"><Link href="/universiteler">Üniversiteler</Link><Link href="/programlar">Programlar</Link><Link href="/istatistikler">İstatistikler</Link><Link href="/hakkimizda#iletisim">İletişim</Link><Link href="/durum">Sistem durumu ↗</Link></nav></footer>
       </NotificationProvider>
      </body>
    </html>
  );
