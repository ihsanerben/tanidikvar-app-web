...
export default async function PopularPage({searchParams}:{searchParams:Promise<{sayfa?:string;donem?:string}>}) {
  ...
  return <section className="legacy-questions questions-page">
    <div className="legacy-questions-heading"><PageTitle help="Dönemler İstanbul saatine göre takvim bazlıdır: bugün 00.00, bu hafta Pazartesi 00.00, bu ay ayın ilk günü ve bu yıl 1 Ocak başlangıç alınır.">Popülerler</PageTitle></div>
