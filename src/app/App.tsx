...
import { AboutPage } from '../features/home/HomePage'
...
export function App() {
  ...
  return <>
    ...
    <main id="main"><Routes>
      ...
      <Route path="/account" element={<AccountPage />} /><Route path="/account/status" element={<AccountPage status />} /><Route path="/" element={<Navigate to="/questions" replace />} /><Route path="/about" element={<AboutPage />} /><Route path="/durum" element={<StatusPage />} /><Route path="*" element={<section className="status-page"><span className="eyebrow">404</span><h1>Bu sayfayı bulamadık.</h1><Link className="button" to="/">Ana sayfaya dön</Link></section>} /></Routes></main>
