...
export const roleLabels:Record<string,string>={USER:'Yeni üye',YKS_ADAYI:'YKS Adayı',UNIVERSITE_OGRENCISI:'Üniversite Öğrencisi',MEZUN:'Mezun',TANIDIK:'Tanıdık',MANAGER:'Manager'}
