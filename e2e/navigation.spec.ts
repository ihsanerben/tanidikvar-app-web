...
test('opens questions, offers list filters and provides the about guide PDF',async({page,request},testInfo)=>{
 ...
 await page.getByLabel('Bu üniversitedeki bölüm',{exact:true}).selectOption({label:'Bilgisayar Mühendisliği'})
 await page.getByLabel('Etiket',{exact:true}).selectOption({label:'Erasmus'})
